select snapshot_id, run_id, fetched_at, (fetched_at at time zone 'UTC')::date as day, chain_id, lower(vault_address) as vault_address, name, symbol, listed,
       ...
       fee * 100 as fee_pct, management_fee * 100 as management_fee_pct, idle_assets_usd, vault_version, share_price_usd, lower(curator_address) as curator_address, curator_ids, curator_names,
